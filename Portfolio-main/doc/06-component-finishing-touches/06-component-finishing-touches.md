...
Overall, I now understand software development better because I experienced the entire lifecycle, not just isolated programming exercises or the concepts.

> Also, did the portfolio project surface any gaps in your own knowledge of
> software development. If so, what are those gaps and how did you address them?

The portfolio project made me relize my forgetfullness of concepts we learned in class and forced me to double check to re learn stuff in class.

> Finally, as a part of completing the portfolio project, to what extent has
> your perspective of software development changed, if at all? In other words,
> is software development something you still enjoy? If not, why not?

This project required a level of planning and polish that made the final result feel more rewarding and made me appriciate the art of end to end coding. :)
...
I also improved my ability to debug systematically as well as ask others (excluding haree) about errors and improvments.

> The follow-up question is: could you rephrase these skills you picked up
> as bullet points that you could put on a resume? Try it below.

Designed and implemented a full software component using formal specifications

Developed comprehensive JUnit test suites for kernel and secondary methods

Used GitHub for version control, branching, and project organization

Practiced independent debugging, refactoring, and code quality improvement

> Next, how has working on this project affected your career trajectory?
> In other words, do you now hate the topic you picked? Or, are you even more
> interested in it? Both outcomes are valuable to your personal development.

Working on this project actually made neither more or less intrested.
...
To continue on this trajectory, I could take on more projects that emphasize software design and continue to post my current learning and projects and github with the level of ssophfistication this project required.
